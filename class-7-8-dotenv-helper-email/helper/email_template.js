          ...
          <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main"
            ...
            <tr>
              <td class="wrapper"
                ...
                <p
                  style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;">
                  Welcome! to our family. Hope you will enjoy with us for new technology newsletters.</p>
                          ...
                          <tbody>
                            <tr>
                              <td
                                ...
                                <a href="http://localhost:8000/verify/?email={{email}}"
                                  target="_blank"
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0"
              ...
              <tr>
                <td class="content-block"
                  ...
                  <span class="apple-link" style="color: #9a9ea6; font-size: 16px; text-align: center;">
                    Syncmachine Inc, Pashim Madarbari, Chattogram.</span>
                  <br> Don't like these emails? <a href="http://syncmachine.com/unsubscribe?email={{email}}"
              ...
              <tr>
                <td class="content-block powered-by"
                  style="font-family: Helvetica, sans-serif; vertical-align: top; color: #9a9ea6; font-size: 16px; text-align: center;"
                  valign="top" align="center">
                  Powered by <a href="http://syncmachine.com" target="_blank"
                    style="color: #9a9ea6; font-size: 16px; text-align: center; text-decoration: none;">syncmachine, inc</a>
                </td>
              </tr>
            </table>
          </div>
